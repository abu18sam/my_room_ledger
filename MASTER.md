...
| **BR-03** | **Independent Ledgers & Electricity Pass-Through** | Rent & Electricity are independent entities. Electricity is pass-through (not profit). Tracks Surplus/Deficit variance vs. UPCL master bill. | [BR-03](docs/business-rules.md#br-03-strict-independent-payment-separation--electricity-pass-through-model) |
