...
2. **[NEW REQUIREMENT ADDITION] Scalable Node.js Backend API**:
   ...
   - **Authentication**: JWT stateless authentication — access tokens (15-min expiry, in-memory) + refresh tokens (7-day expiry, `HttpOnly` cookie) with bcrypt password hashing (12 rounds).
