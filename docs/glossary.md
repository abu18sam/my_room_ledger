...
| **Argon2id Password Hashing** | OWASP-recommended memory-hard key derivation function used to hash user authentication credentials securely. | BR-10.2, NFR-02, docs/03-non-functional-requirements.md |
